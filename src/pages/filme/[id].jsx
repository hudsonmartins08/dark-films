                    ...
                    <div className="w-[40%] h-full flex flex-col">
                        <div className="w-full h-[90%] ">
                            <img
                                ...
                                src="https://th.bing.com/th/id/OIP.wQNlUkwJYn16LGVQel23KwHaKW?rs=1&pid=ImgDetMain"
                                alt=""
                            />
                        </div>
                        <div className="w-full flex h-[10%] pt-4 justify-between">
                            <button className="w-[49%] h-full border border-[#9b87f533] rounded-md text-[#9b87f5] hover:bg-[#9b87f5]/20 flex items-center justify-center gap-2 py-1">
                            <BiSolidEdit size={15}/>Editar filme</button>
                            <button className="w-[49%] h-full border border-[#ef444433] rounded-md text-[#ef4444] hover:bg-[#ef4444]/20 flex items-center justify-center gap-2 py-1">
                            <FaRegTrashAlt size={15}/> Excluir filme</button>
                        </div>
                    </div>
                    <div className="w-[60%] h-full flex flex-col pl-4">
                        <div className="w-full flex gap-2 items-baseline">
                            <h1 className="text-[30px] text-[#9b87f5] font-bold">Bairro 13</h1>
                            <p className="text-[#8a898c] font-semibold text-[16px]">(2004)</p>
                        </div>
                        ...
                        <div className="w-full flex flex-col pt-4">
                            ...
                            <p className="text-[#8a898c]">Pierre Morel</p>

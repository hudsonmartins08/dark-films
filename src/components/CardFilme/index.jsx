...
export default function CardFilme({ filme }){
    ...
    return(
        <div 
            ...
            className="w-[330px] h-[318px] flex flex-col rounded-lg bg-[#222222] cursor-pointer border border-transparent hover:border-[#8f7bd8] transition-all duration-400 ease-in-out">
